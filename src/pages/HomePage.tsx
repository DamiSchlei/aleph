...
const WEEK_WINDOW = 6
const DEFAULT_CAP = 5
const SNAP_CLASS = 'w-[calc(100%-1.25rem)] shrink-0 snap-center px-1.5'
        ...
        title={
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1">
              ...
              <div className="flex rounded-2xl border border-line-strong bg-subtle p-0.5">
                {(['day', 'week'] as const).map((mode) => (
                  <button
                    ...
                    className={cx(
                      'min-h-11 rounded-xl px-3 text-[14px] font-medium',
...
function WeekColumn({
  ...
  return (
    <section className={cx('flex flex-col gap-3', className)}>
      <div className="sticky top-0 z-10 -mx-1.5 bg-bg/95 px-1.5 py-2 backdrop-blur">
        <div className="flex items-end justify-between gap-2">
          <h2 className="text-[28px] leading-none font-semibold text-ink">
